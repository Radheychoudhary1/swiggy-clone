...
const Menu = (props:menuProp) => {
  return (
    <div className='flex items-center mt-10 overflow-scroll no-swiggy-scrollbar'>
        <div className='cursor-pointer' onClick={()=> props?.setMenu("American")}>
            <img src={burger} className='w-36 h-32 rounded-full' alt="American"/>
            <h1 className='font-semibold text-gray-500 text-xl ml-6'>American</h1>
        </div>
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Indian")}>
            <img src={biriyani} className='w-36 h-32 rounded-full' alt="Indian"/>
            <h1 className='font-semibold text-gray-500 text-xl ml-6'>Indian</h1>
        </div>
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Chinese")}>
            <img src={pizza} className='w-36 h-32 rounded-full' alt="Chinese"/>
        ...
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Asian")}>
            <img src={chinese} className='w-36 h-32 rounded-full' alt="Asian"/>
        ...
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Indonesian")}>
            <img src={shawarma} className='w-36 h-32 rounded-full' alt="Indonesian"/>
        ...
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Italian")}>
            <img src={pasta} className='w-36 h-32 rounded-full' alt="Italian"/>
            <h1 className='font-semibold text-gray-500 text-xl ml-6'>Italian</h1>
        </div>
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("Salad")}>
            <img src={salad} className='w-36 h-32 rounded-full' alt="Salad"/>
        ...
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("European")}>
            <img src={pancake} className='w-36 h-32 rounded-full' alt="European"/>
        ...
        <div className='ml-12 cursor-pointer' onClick={()=> props?.setMenu("International")}>
            <img src={cake} className='w-36 h-32 rounded-full' alt="International"/>
